    ...
    return (
        <div id='about' className='my-container md:grid md:grid-cols-2 gap-6 items-center'>
            ...
            <div>
                ...
                <Link target="_blank" data-aos="fade-up" to={'https://drive.google.com/file/d/1TdOHskpWA7kO3md-LKCJDFd-2k-pc0v-/view?usp=sharing'} className="btn btn-warning">Download Resume <AiOutlineDownload className='text-white text-2xl'></AiOutlineDownload></Link>
            </div>
        </div>
    );
};
