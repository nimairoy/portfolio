        ...
        <div id='service' className="bg-purple-600 pt-16 pb-24">
            <div className='my-container'>
                ...
                <div className='grid md:grid-cols-4 md:gap-4'>
                    ...
                    <div data-aos="fade-down" data-aos-duration="3000" className="card rounded-md w-full bg-base-100 shadow-xl">
                        <figure className="px-10 pt-10">
                    ...
                    <div data-aos="fade-up" data-aos-duration="4000" className="card rounded-md w-full bg-base-100 shadow-xl">
                        <figure className="px-10 pt-10">
                    ...
                    <div data-aos="fade-left" data-aos-duration="6000" className="card rounded-md w-full bg-base-100 shadow-xl">
                        <figure className="px-10 pt-10">
