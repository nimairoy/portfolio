...
const Contact = () => {
    return (
        <div className='my-container pb-16 pt-12'>
            <h4 className='text-5xl text-center font-semibold mb-12 mt-16'>Contact Me</h4>
            <div className=" md:grid md:grid-cols-2 gap-4 items-center">
                <div>
                    ...
                    <h4 className='text-3xl mt-8 font-semibold mb-4'>Social Links</h4>
                ...
                <div className="border rounded-md shadow-xl py-12 px-4 border-indigo-100">
                    <h4 className='text-3xl font-semibold mb-4'>Send Message</h4>
                    <form className='pb-6 text-center'>
                        ...
                        <button type='submit' className='btn btn-primary w-full rounded-none mt-4'>Submit</button>
