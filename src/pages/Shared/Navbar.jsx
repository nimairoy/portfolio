            ...
            <div className="navbar my-container">
                <div className="navbar-start md:w-1/2 w-full">
                    <div className="dropdown">
                        ...
                        <ul style={ {backgroundColor: "#8222ea"} } tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52">
                            {navbarItems}
                        </ul>
                    </div>
                    <a className="btn btn-ghost md:ml-0 ml-auto text-yellow-400 text-xl">Dev Nimai</a>
                </div>
